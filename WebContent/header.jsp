...
<body>
  ...
  <div class="modal-dialog">
		                            ...
		                            <div class="tab-pane" id="Registration">
		                                ...
		                                <div class="row">
		                                    ...
		                                    <div class="col-sm-10">
		                                        ...
		                                        <input type=reset name="reset" class="btn btn-default btn-sm">
	...
	%>
			<form role="form" class="form-horizontal" action="Logout" method="post">
...
<body>
  ...
  <div class="modal-dialog">
   ...
   <div class="header-top-right">
	...
	<!-- button trigger modal  -->
	<p>
	<%	session.setAttribute("username", "User2");	//temporary
...
$('#myModal').modal('show');
	...
	<%	}
			...
			<form role="form" class="form-horizontal" action="logoutservlet" method="post">
			<button type="submit" class="btn btn-primary btn-sm" >Logout</button>
			</form>
	<%	}	%>
	</div>
